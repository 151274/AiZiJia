...
//列表
$arr["list"]=$select->table("xianluxiangqing")->join("xianlupic","xianluxiangqing.id=xianlupic.xid")->limit(0,18)->select();
//领队
$arr["lingdui"]=$select->table("lingdui")->select();
//活动数
$arr["huodong"]=$select->table("xianluxiangqing")->rowCount();
$smarty->assign("arr",$arr);
$smarty->display("chengshisousuo.html");